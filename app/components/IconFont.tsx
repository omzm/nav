...
const PATHS: Record<string, string> = {
  ...
  'icon-globe': 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM3.5 12h17M12 3c2.2 2.4 3.3 5.4 3.3 9S14.2 18.6 12 21c-2.2-2.4-3.3-5.4-3.3-9S9.8 5.4 12 3Z',
  'icon-home': 'M3 11 12 4l9 7v9a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1v-9Z',
  ...
  'icon-pen': 'M4 20h4L19 9a2.1 2.1 0 0 0-3-3L5 17l-1 3Z',
  ...
  'icon-search': 'M11 18a7 7 0 1 0 0-14 7 7 0 0 0 0 14Zm5-2 4 4',
  'icon-server': 'M5 4h14a1 1 0 0 1 1 1v5H4V5a1 1 0 0 1 1-1Zm-1 10h16v5a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-5Zm4-6h.01M8 17h.01',
  'icon-tool': 'M14.5 6.5 17 4l3 3-2.5 2.5M4 20l7.5-7.5M15 5a5 5 0 0 0-6.8 6.8L3 17l4 4 5.2-5.2A5 5 0 0 0 19 9',
};
